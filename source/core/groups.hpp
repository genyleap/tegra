 ...
 */
class __tegra_export Groups : public Abstracts::Account::AbstractGroups
{
public:
     ...
     * \returns boolean.
     */
    __tegra_no_discard bool add(const Abstracts::Account::GroupData& groupData) __tegra_const_noexcept_override;
     ...
     * \returns boolean.
     */
    __tegra_no_discard bool edit(const u32 id, const Abstracts::Account::GroupData& groupData) __tegra_const_noexcept_override;
     ...
     */
    __tegra_no_discard Abstracts::Account::GroupData get(const u32 id) __tegra_const_noexcept_override;
